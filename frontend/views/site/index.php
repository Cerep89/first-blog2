                                ...
                                <div class="row">
                                    <div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 text-center">
                                        <div class="b-home-slider-content">
                                            ...
                                            <div class="home-slider-text">
                                                Et harum quidem rerum facilis est et expedita ut aut reiciendis
                                                voluptatibus maiores alias consequatur
                                                <br>
                                                Itaque earum rerum hic tenetur a sapiente delectus, aut perferendis
                                                doloribus
                                                <br>
                                                perferendis doloribus asperiores repellat asperiores repellat. Nam
                        ...
                        <div class="row equal">
                            <div class="col-xs-12 col-sm-4 col-md-4 wow slideInRight">
                                <div class="b-features-column">
                                    <div class="features-column-icon">
                                        <i><img src="<?= 'photos/' . $val['first_image_left'] ?>" alt="" width="64" height="64"></i>
                                    </div>
                                    <h6 class="features-column-title">
                                        <?= $val['first_title_left'] ?>
                                    </h6>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInUp">
                                <div class="b-features-column even-features-column">
                                    <div class="features-column-icon">
                                        <i><img src="<?= 'photos/' . $val['first_image_center'] ?>" alt="" width="64" height="64"></i>
                                    </div>
                                    <h6 class="features-column-title">
                                        <?= $val['first_title_center'] ?>
                                    </h6>
                                    <div class="features-column-text">
                                        <?= $val['first_text_center'] ?>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 wow slideInLeft">
                                <div class="b-features-column">
                                    <div class="features-column-icon">
                                        <i><img src=" <?= 'photos/' . $val['first_image_right'] ?>" alt="" width="64" height="64"></i>
                                    </div>
                                    <h6 class="features-column-title">
                                        <?=  $val['first_title_right'] ?>
                                    </h6>
                                    <div class="features-column-text">
                                        <?= $val['first_text_right'] ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="b-items-gallery-holder">
                    <div class="js-zoom-gallery grid clearfix">
                        ...
                        <div class="b-gallery-3__item grid-item web illustration photography">
                            <div class="gallery-item-content">
                                <div class="gallery-item-img">
                                    <img src="public/media/components/b-gallery/gallery-mid-1.jpg" alt="/"
                                         class="img-responsive">
                                    <div class="gallery-item-hover">
                                        <a href="public/media/components/b-gallery/gallery-mid-1.jpg"
                                           class="js-zoom-gallery__item">
                                            <span class="item-hover-icon"><i class="fa fa-search"
                        ...
                        <div class="b-gallery-3__item grid-item illustration photography">
                            <div class="gallery-item-content">
                                <div class="gallery-item-img">
                                    <img src="public/media/components/b-gallery/gallery-mid-2.jpg" alt="/"
                                         class="img-responsive">
                                    <div class="gallery-item-hover">
                                        <a href="public/media/components/b-gallery/gallery-mid-2.jpg"
                                           class="js-zoom-gallery__item">
                                            <span class="item-hover-icon"><i class="fa fa-search"
                                                                             aria-hidden="true"></i></span>
                                            <img src="public/media/components/b-gallery/gallery-mid-2.jpg" alt="/"
                        ...
                        <div class="b-gallery-3__item grid-item branding web">
                            <div class="gallery-item-content">
                                <div class="gallery-item-img">
                                    <img src="public/media/components/b-gallery/gallery-mid-3.jpg" alt="/"
                                         class="img-responsive">
                                    <div class="gallery-item-hover">
                                        <a href="public/media/components/b-gallery/gallery-mid-3.jpg"
                                           class="js-zoom-gallery__item">
                                            <span class="item-hover-icon"><i class="fa fa-search"
                                                                             aria-hidden="true"></i></span>
                                            <img src="public/media/components/b-gallery/gallery-mid-3.jpg" alt="/"
                        ...
                        <div class="b-gallery-3__item grid-item branding web">
                            <div class="gallery-item-content">
                                <div class="gallery-item-img">
                                    <img src="public/media/components/b-gallery/gallery-mid-4.jpg" alt="/"
                                         class="img-responsive">
                                    <div class="gallery-item-hover">
                                        <a href="public/media/components/b-gallery/gallery-mid-4.jpg"
                                           class="js-zoom-gallery__item">
                                            <span class="item-hover-icon"><i class="fa fa-search"
                                                                             aria-hidden="true"></i></span>
                                            <img src="public/media/components/b-gallery/gallery-mid-4.jpg" alt="/"
                        ...
                        <div class="b-gallery-3__item grid-item grid-item-vertic">
                            <div class="gallery-item-content">
                                <div class="gallery-item-img">
                                    <img src="public/media/components/b-gallery/gallery-mid-vertic.jpg" alt="/"
                                         class="img-responsive">
                                    <div class="gallery-item-hover">
                                        <a href="public/media/components/b-gallery/gallery-mid-vertic.jpg"
                                           class="js-zoom-gallery__item">
                                            <span class="item-hover-icon"><i class="fa fa-search"
                                                                             aria-hidden="true"></i></span>
                                            <img src="public/media/components/b-gallery/gallery-mid-vertic.jpg" alt="/"
                        ...
                        <div class="b-gallery-3__item grid-item grid-item-horiz branding illustration">
                            <div class="gallery-item-content">
                                <div class="gallery-item-img">
                                    <img src="public/media/components/b-gallery/gallery-mid-horiz.jpg" alt="/"
                                         class="img-responsive">
                                    <div class="gallery-item-hover">
                                        <a href="public/media/components/b-gallery/gallery-mid-horiz.jpg"
                                           class="js-zoom-gallery__item">
                                            <span class="item-hover-icon"><i class="fa fa-search"
                                                                             aria-hidden="true"></i></span>
                                            <img src="public/media/components/b-gallery/gallery-mid-horiz.jpg" alt="/"
                        ...
                        <div class="b-gallery-3__item grid-item web illustration">
                            <div class="gallery-item-content">
                                <div class="gallery-item-img">
                                    <img src="public/media/components/b-gallery/gallery-mid-5.jpg" alt="/"
                                         class="img-responsive">
                                    <div class="gallery-item-hover">
                                        <a href="public/media/components/b-gallery/gallery-mid-5.jpg"
                                           class="js-zoom-gallery__item">
                                            <span class="item-hover-icon"><i class="fa fa-search"
                                                                             aria-hidden="true"></i></span>
                                            <img src="public/media/components/b-gallery/gallery-mid-5.jpg" alt="/"
                        ...
                        <div class="b-gallery-3__item grid-item illustration">
                            <div class="gallery-item-content">
                                <div class="gallery-item-img">
                                    <img src="public/media/components/b-gallery/gallery-mid-6.jpg" alt="/"
                                         class="img-responsive">
                                    <div class="gallery-item-hover">
                                        <a href="public/media/components/b-gallery/gallery-mid-6.jpg"
                                           class="js-zoom-gallery__item">
                                            <span class="item-hover-icon"><i class="fa fa-search"
                                                                             aria-hidden="true"></i></span>
                                            <img src="public/media/components/b-gallery/gallery-mid-6.jpg" alt="/"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 col-md-3">
                                ...
                                <a href="<?= $val['two_button_link_left'] ?>" class="btn btn-primary btn-ask">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3 col-md-offset-1">
                                <div class="b-links">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <a href="<?= $val['two_link_one_right'] ?>">
                                                <?= $val['two_text_link_one_right'] ?>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= $val['two_link_two_right'] ?>">
                                                <?= $val['two_text_link_two_right'] ?>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= $val['two_link_three_right'] ?>">
                                                <?= $val['two_text_link_three_right'] ?>
                                            </a>
                                        </li>
                                      <!-- =================
                                      End Section two
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <div class="mac-wrapper-mod wow slideInRight">
                                        ...
                                        <a href="#">
                                            <img src="public/media/components/b-service/service-gallery-1.jpg"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-5 text-center">
                                    <div class="about-additional-img">
                                        <img src="public/media/components/b-service/about-additional-img.jpg"
                                             class="img-responsive" alt="/">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-md-offset-1">
                                    <div class="about-additional-content">
                                        ...
                                        <div class="about-additional-text">
                                            ...
                                            aliquet. Curabitur blandit vestibulum luctus. In hac habitasse platea
                                            dictumst. Aenean ullamcorper, leo id rutrum convallis, velit mauris
                                            porttitor orci, a posuere massa diam eu dui.
                                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="offers-info-text col-xs-12 col-sm-12 text-center">
                                Nullam aliquam eros a ex hendrerit, at eleifend elit gravida. Nulla lorem erat, varius
                                et maximus at,
                                <br>
                                                ...
                                                <div class="pager-item">
                                                    <div class="review-item text-center">
                                                        ...
                                                        <div class="review-text">
                                                            “ Donec nibh felis, pulvinar nec erat id, venenatis semper
                                                            magna. Sed lacus velit, cursus sed libero non, auctor
                                                            hendrerit neque. Suspendisse ornare nulla neque. Cras libero
                                                            urna, aliquam sed massa eu, lobortis euismod magna. ”
                                                        </div>
                                            ...
                                            <li>
                                                <div class="pager-item">
                                                    <div class="review-item text-center">
                                                        ...
                                                        <div class="review-text">
                                                            “ Sed lacus velit, cursus sed libero non, auctor hendrerit
                                                            neque. Cras libero urna, aliquam sed massa eu, lobortis
                                                            euismod magna. ”
                                                        </div>
                                                        <div class="review-author">
